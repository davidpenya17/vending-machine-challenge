...
use App\Domain\Model\Juice;
use PhpSpec\ObjectBehavior;

class JuiceSpec extends ObjectBehavior
{
    const SOME_STOCK = 10;
    ...
    {
        $this->shouldHaveType(Juice::class);
    }
    ...
    public function it_should_return_is_available_to_buy(
        Coin $coin1,
        Coin $coin2
    ) {
        //Given
        $coin1->getValue()->willReturn(0.10);
        $coin2->getValue()->willReturn(0.25);
        $coins = [$coin1, $coin1, $coin1, $coin2, $coin2, $coin2];
